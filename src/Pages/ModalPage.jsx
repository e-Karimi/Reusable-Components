...
export default function ModalPage() {
    ...
    const actionBar = (
        <div className="flex justify-end gap-x-2">
            <Button onClick={() => setShow(false)} role='danger' rounded >
                close
            </Button>

            <Button onClick={() => confirm()} role='success' rounded>
                accept
            </Button>
        </div>
    )
    ...
    return (
        <div>
            ...
            <Button onClick={() => setShow(prev => !prev)} role="primary" rounded >
                Open Modal
            </Button>


            {show &&
                <Modal onClose={() => setShow(false)} actionBar={actionBar}>
                    <p>
                        are you sure you are going to countinue?
                        If you need,please call to 09198319490.
                    </p>
                </Modal>
            }
